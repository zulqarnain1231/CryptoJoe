...
const TableItem = ({rank,title,logo,volume,change24h,change7d,price}) => {
  return (
    <div className='grid md:grid-cols-6 grid-cols-2  hover:bg-slate-200 cursor-pointer rounded-lg  p-4'>
      
      <div className='md:col-span-2 flex gap-6 sm:gap-[2rem] md:gap-16 lg:gap-20'>
