...
const Item = ({title,img,color,border,link}) => {
  ...
  return (
    <Link href={`/${link}`} >
    <div className={`my-4 rounded-2xl text-center hover:border-[${border}] border hover:border px-8 pt-8 pb-10 group bg-[${color}]  lg:h-[17rem] lg:w-[17rem] sm:h-56 sm:w-56 h-40 w-40 col-span-1 relative cursor-pointer `}>
        <div>
