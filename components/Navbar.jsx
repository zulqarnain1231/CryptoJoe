...
//  }
  return (<>
    <div className='hidden lg:flex justify-between z-10 fixed w-full bg-[#F3EEEA] p-2'>
        <Link href='/' >
      ...
      <div>
        <button className='flex gap-1 mt-1 rounded-full bg-white py-2 hover:bg-[#ECECFE] px-4'>
...
{/* secondary navbar */}
    ...
    <div className='flex lg:hidden justify-between z-10 fixed w-full bg-[#F3EEEA] p-2'>
        <Link href='/' >
      <div className='h-10 w-10 py-0'>
        <Image className='cursor-pointer hover:-rotate-6 duration-150 object-cover h-full w-full mt-2' src={logo} />
     ...
     <div className='flex px-2 justify-between border lg:hidden w-full z-10 bg-white bottom-0 fixed   py-1'>
